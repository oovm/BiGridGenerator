...
Quiet[DeclarePackage@@@{
  ...
  {"CCPSolver`",{}},
  {"LightOut`",{}},
  {"MagicSquare`",{"Magic","Magic3D","Magic3DQ","Magic3DShow","MagicQ","MagicSquare","MagicSquare$Environment",
    "MagicSquare$LastUpdate","MagicSquare$Version"}},
  ...
  {"WordGames`",{}},{"IrwinSums`",{"iPartialSum","iPartialSumThreshold","IrwinSum","IrwinSums","IrwinSum$","iSumFormatted","setPrintLevel"}},
  ...
  {"QuinticEquation`",{}},{"RiemannSurfacePlot3D`",{"BranchPointOffset","Coloring","LogSheets","NDSolveOptions","RiemannSurfacePlot3D","StitchPatches"}},
  {"SortAlgorithm`",{}}
};]
